...
function Cards() {
  return (
    <section
      className="
        w-full max-w-[1300px] mx-auto pb-8 px-4
        flex gap-6
      ...
      {servicios.map((servicio, index) => (
        <div
          ...
          className="
            ...
            group relative min-h-[400px] overflow-hidden rounded-xl shadow-lg
            transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:shadow-orange-500/30
          "
        >
          {/* Título */}
          <div
            className="absolute top-0 left-0 w-full bg-black/80 text-white min-h-[60px] flex items-center justify-center z-30"
            data-aos="fade-up"
          >
